...
//
$_SESSION["pos"] = "bill";
$_SESSION["active"] = "bista";
//
require_once("../app/models/BillstaticModel.php");
require_once("components/BillstaticLibrary.php");
require_once("components/Paging.php");
//Khởi tạo đối tượng
$bsm = new BillstaticModel();
$similar = new BillstaticObject();

//Lấy chỉ số cho phân trang
$url = "/hostay/admin/billstatics.php?";
$page = 1;
$totalperpage = 10;
$total = $bsm->countBillstatic($similar);
if(isset($_GET["page"])) {
    $savePage = $_GET["page"];
...
//Lấy danh sách
$items = $bsm->getBillstatics($similar, $page, $totalperpage);
